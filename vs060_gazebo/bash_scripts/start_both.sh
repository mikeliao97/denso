...
tmux split-window -v "source setup && roslaunch vs060_gazebo arm-hand-gazebo.launch"
...
tmux split-window -h "source setup && roslaunch arm-hand_moveit_config arm-hand_planning_execution.launch"
